...
class TestReasonsMatchFilters(unittest.TestCase):
    ...
    def test_reason_says_where_the_word_was_found(self):
        ...
        «Продавец» в заголовке — вакансия не наша, спорить не о чем. То же
        слово в описании — уже повод присмотреться: у профильных вакансий
        ...
        self.assertEqual(
            ...
            "не ИИ-профессия")
        self.assertEqual(
            filters.job_reject_reason("AI-инженер", "удалённо, llm, продажи растут"),
