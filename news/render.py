...
/* --- Главное за сутки -----------------------------------------------------
   Слева свежая новость крупно, справа три к ней. Блок собран из чужого
...
TICKER_LIMIT = 12
# Главная новость и три к ней. Четыре записи в правой колонке выше основной
# карточки, и сетка растягивает её под колонку — внутри остаётся пустая
# полоса сантиметров в два. С тремя высоты сходятся.
HERO_LIMIT = 4
...
def _hero_html(all_news):
    """Акцентный блок: главная новость крупно и три к ней.
